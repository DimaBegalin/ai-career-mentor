...
const QUESTIONS = [
  { id:"dream", emoji:"💰", title:"Если деньги вообще не нужны…", sub:"Что бы ты делал каждый день?",
    options:[
      { t:"Создавал бизнес",   tags:{business:3,marketing:1}, stats:{leadership:14}, r:{e:"✨",t:"Интересно…",n:"В бизнес-программы Азии и Европы берут с IELTS от 6.0, а свой проект в заявке весит больше оценок. Фиксируй всё, что уже запускал — это твой главный аргумент."} },
      { t:"Учил людей",        tags:{education:3,business:1}, stats:{leadership:10}, r:{e:"⚡",t:"У тебя сильное влияние на людей.",n:"EdTech — рынок на $400 млрд, и грант GKS в Корее покрывает такие программы полностью. Влияние на людей — сильнейший материал для эссе."} },
      ...
      { t:"Исследовал космос", tags:{science:3,engineering:1},stats:{academic:10},   r:{e:"🔭",t:"Редкий выбор.",n:"Research-вузы вроде KAIST и TU München берут за олимпиады и научные проекты, а GKS и MEXT покрывают их полностью. Начни с одного исследования в 10–11 классе."} },
      ...
      { t:"Лечил людей",       tags:{medicine:3},             stats:{academic:10},   r:{e:"🩺",t:"Серьёзный путь.",n:"В медицину с полным грантом проще всего через Венгрию (Stipendium Hungaricum) и Корею (GKS). Качай биологию и химию до олимпиадного уровня уже сейчас."} },
    ]},
  { id:"school", emoji:"⚡", title:"Что в школе даётся легче всего?", sub:"Честно — без «надо стараться».", multi:true,
    options:[
      ...
      { t:"Биология и химия",      tags:{medicine:3,science:1},          stats:{academic:15}, r:{e:"🧬",t:"Сильная база.",n:"Это фундамент медицины и биотеха — Stipendium Hungaricum в Венгрии полностью покрывает Medicine. Добавь 1–2 олимпиады по био или химии — и заявка станет конкурентной."} },
  ...
  { id:"power", emoji:"🦸", title:"Выбери суперсилу", sub:"Одну. Навсегда.",
    options:[
      ...
      { t:"Решать нерешаемое", tags:{cs:2,engineering:2},     stats:{academic:12},   a:"Аналитический склад ума", r:{e:"🧠",t:"Инженерное мышление.",n:"Это прямая дорога в KAIST и NTU, где GKS и сингапурские стипендии покрывают всё. Олимпиада по математике или физике удвоит твои шансы."} },
  ...
  { id:"english", emoji:"🗣️", title:"Твой английский сейчас?", sub:"Без прикрас — это важно для расчёта.",
    options:[
      { t:"Свободно говорю",          stats:{english:35}, meta:{eng:"C1"}, r:{e:"🇬🇧",t:"Красавчик.",n:"IELTS 7.0+ для тебя — 1–2 месяца на формат и пробники. С таким баллом проходишь пороги почти всех грантов: GKS, MEXT, Stipendium Hungaricum."} },
  ...
  { id:"gpa", emoji:"📊", title:"Твой средний балл?", sub:"Примерно, за последний год.",
    options:[
      { t:"5.0 – 4.5", stats:{academic:25}, meta:{gpa:"5.0-4.5"}, r:{e:"🎓",t:"С таким GPA открыты топ-вузы.",n:"Ты проходишь академический порог GKS, MEXT и Stipendium Hungaricum. Дальше всё решают IELTS и внеклассная часть заявки."} },
      { t:"4.4 – 4.0", stats:{academic:18}, meta:{gpa:"4.4-4.0"}, r:{e:"👍",t:"Крепкий уровень.",n:"Для большинства грантовых программ Европы и Азии этого достаточно. Добавь IELTS 6.5+ — и селективные вузы тоже в игре."} },
  ...
  { id:"exams", emoji:"📝", title:"IELTS и SAT уже сдавал?", sub:"Официальные экзамены, не пробники.",
    options:[
      ...
      { t:"Только IELTS",           stats:{english:12},             meta:{ielts:true,sat:false}, r:{e:"📗",t:"Хороший задел.",n:"Для Европы и Азии SAT часто не нужен: GKS, MEXT и Stipendium Hungaricum принимают без него. IELTS у тебя уже есть — а это главный фильтр."} },
  ...
  { id:"ielts_score", emoji:"📗", title:"Какой у тебя балл IELTS?", sub:"Официальный overall score.", cond:()=>S.meta.ielts===true,
    options:[
      { t:"7.5 и выше",   stats:{english:23}, meta:{ieltsScore:"7.5+"},  r:{e:"🏆",t:"Топ-уровень.",n:"Это выше порога Оксфорда, NUS и всех азиатских грантов. Языковой фильтр для тебя закрыт полностью — вкладывай время в остальную заявку."} },
      { t:"7.0",          stats:{english:18}, meta:{ieltsScore:"7.0"},   r:{e:"🚀",t:"Сильный балл.",n:"Проходишь языковой порог топ-программ, включая GKS и сингапурские стипендии. Пересдача не нужна — займись эссе и портфолио."} },
      { t:"6.5",          stats:{english:13}, meta:{ieltsScore:"6.5"},   r:{e:"👍",t:"Рабочий балл.",n:"Стандартный порог Европы и Азии — проходишь в большинство программ с грантами. Топ-США иногда просят 7.0 — реши, нужно ли оно тебе."} },
      { t:"6.0",          stats:{english:8},  meta:{ieltsScore:"6.0"},   r:{e:"📘",t:"База есть.",n:"Хватает для GKS и Stipendium Hungaricum, но топ-программы просят 6.5+. Пересдача после 2–3 месяцев подготовки обычно даёт +0.5."} },
  ...
  { id:"sat_score", emoji:"🧮", title:"Какой у тебя балл SAT?", sub:"Суммарный результат.", cond:()=>S.meta.sat===true,
    options:[
      { t:"1450 и выше", stats:{academic:20}, meta:{satScore:"1450+"},     r:{e:"🏆",t:"Уровень Ivy League.",n:"Это уровень самых селективных вузов США и полных merit-стипендий. Подавай смело — твой SAT там конкурентен."} },
      { t:"1350 – 1440", stats:{academic:15}, meta:{satScore:"1350-1440"}, r:{e:"🚀",t:"Сильный результат.",n:"Открыты десятки университетов США с грантами 50–100%. Для Ivy League стоит пересдать на 1500+ — обычно это +100 баллов за 2–3 месяца."} },
      ...
      { t:"До 1200",     stats:{academic:5},  meta:{satScore:"до 1200"},   r:{e:"💪",t:"Точка старта.",n:"Пересдача с подготовкой обычно даёт +100–200 баллов за 2–3 месяца. А в Европе и Азии SAT часто вообще не требуют."} },
    ]},
  { id:"grant", emoji:"🎓", title:"Как планируешь оплачивать учёбу?", sub:"От этого зависит список вузов.",
    options:[
      { t:"Только полный грант",      meta:{grant:"полный грант"},    r:{e:"🎓",t:"Принято.",n:"Тогда цель — GKS (Корея), MEXT (Япония), Stipendium Hungaricum (Венгрия): покрывают учёбу, жильё и перелёт. На большинство подача до 1 ноября."} },
      { t:"Частичный грант + семья",  meta:{grant:"частичный грант"}, r:{e:"⚖️",t:"Гибкий вариант.",n:"С частичным финансированием выбор вузов в 3 раза шире: почти каждый вуз Европы и Азии даёт merit-скидки 30–70%. Самая гибкая стратегия."} },
      ...
      { t:"Пока не думал",            meta:{grant:"не определился"},  r:{e:"💡",t:"Хорошо, что задумался сейчас.",n:"За 12 месяцев реально выйти на полный грант: GKS, MEXT и Stipendium Hungaricum закрывают всё, включая перелёт. Первый шаг — IELTS."} },
    ]},
  { id:"geo", emoji:"🌍", title:"Где хочешь учиться?", sub:"Первое, что откликается.",
    options:[
      { t:"США",                  meta:{geo:"США"},        r:{e:"🗽",t:"Амбициозно.",n:"Самые большие гранты мира: need-based до 100% в Ivy League и NYU Abu Dhabi. Но и конкурс самый высокий — нужны SAT 1400+ и сильное эссе."} },
      { t:"Европа",               meta:{geo:"Европа"},     r:{e:"🏰",t:"Умный выбор.",n:"Венгрия даёт полный Stipendium Hungaricum, в Германии обучение почти бесплатное. Сотни программ на английском с порогом IELTS 6.0–6.5."} },
      { t:"Азия",                 meta:{geo:"Азия"},       r:{e:"🌏",t:"Тренд десятилетия.",n:"Южная Корея, Гонконг, Китай, Малайзия, Сингапур, Япония — гранты здесь раздают активнее всех. На большинство подача до 1 ноября."} },
      { t:"Казахстан",            meta:{geo:"Казахстан"},  r:{e:"🇰🇿",t:"База рядом.",n:"NU даёт полный гос. грант при NUFYP или IELTS 6.0+. И его можно совмещать с подачей за рубеж — одно другому не мешает."} },
      { t:"Всё равно — где грант", meta:{geo:"любая страна с грантом"}, r:{e:"🎯",t:"Прагматично.",n:"Стратегия «сначала грант» срабатывает чаще всего: GKS, MEXT и Stipendium Hungaricum покрывают всё. Подберём страну под твои баллы."} },
    ]},
  ...
  { id:"future", emoji:"🔮", title:"Кем видишь себя через 10 лет?", sub:"Последний вопрос. Самый важный.",
    options:[
      ...
      { t:"Топ-эксперт в своём деле", tags:{cs:1,engineering:1,science:1}, stats:{academic:10}, r:{e:"🧠",t:"Мастерство.",n:"Глубина побеждает на дистанции: выбирай вузы с сильными лабораториями. KAIST и NTU дают research-трек с полным грантом."} },
      ...
      { t:"Учёный-исследователь",     tags:{science:3},               stats:{academic:10}, r:{e:"🔬",t:"Наука.",n:"Целься в research-университеты: KAIST, HKUST, NUS дают лаборатории с 1 курса и полные гранты. Научный проект в школе — твой входной билет."} },
      { t:"Помогаю людям",            tags:{medicine:2,education:2},  stats:{leadership:6}, r:{e:"❤️",t:"Смысл.",n:"Медицина и образование — сферы, где AI усиливает людей, а не заменяет. Полные гранты на эти направления дают Венгрия (Stipendium Hungaricum) и Корея (GKS)."} },
    ]},
];
