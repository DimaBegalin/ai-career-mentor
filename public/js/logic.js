...
function buildFallbackResult(){
  ...
  return {
    ...
    readiness,
    forecast:`Если начать готовиться сейчас, через 12 месяцев вероятность полного гранта вырастет с ${from}% до ${to}%. Реальный срок подготовки — от 3 до 12 месяцев, зависит от твоей энергии и намерения.`,
    plan:[
