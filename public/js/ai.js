...
ПРИОРИТЕТЫ ПОДБОРА:
- Внутри специальности №1 сначала ищи программы с AI-фокусом (AI in Business, AI Engineering, EdTech/AI и т.п.) — в поле program называй конкретную AI-программу, если она есть.
